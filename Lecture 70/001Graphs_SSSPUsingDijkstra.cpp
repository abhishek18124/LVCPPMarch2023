...
public :
	...
	// time : V.logV + E.logV ~ O(E.logV)

	// graph is sparse : E ~ V time : V.logV + V.logV ~ O(VlogV)
	// graph is dense : E ~ V^2 time : V.logV + V^2logV ~ O(V^2logV)
...
int main() {
	...
	graph<char> g; // todo : initialise the graph with all the vertices for a directed graph
