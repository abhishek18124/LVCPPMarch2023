...
void f(char* inp, int i) {
	...
	if ((inp[i] == 'p' and inp[i + 1] == 'i') || (inp[i] == 'P' and inp[i + 1] == 'I')) {

		// replace "pi" at the (i, i+1)th index with 3.14

		// shift all the characters starting at the (i+2)th index two-steps to the right
		...
		// replace all the pi's with "3.14" in inp[i+4...]
