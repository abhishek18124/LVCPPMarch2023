...
// nodeComparator class is used to build a minHeap based on node values
...
public :
    ...
    bool operator()(ListNode* a, ListNode* b) {
        if (b->val < a->val) {
            // you need a swap to build a minHeap based on node values
            return true;
        }
        // you don't a swap to build a minHeap based on node values
        return false;
    }
